...
(function () {
  ...
  var TR = {
    en: {
      ...
      // Guest CTA
      'gcta.headline': 'Become a Beta Tester',
      'gcta.subtitle': "We're launching soon in Zurich. Drop your email and be among the first to try it.",
      'gcta.email_ph': 'Your email address',
      'gcta.btn': 'Become a Beta Tester',
      'gcta.success': "You're on the list! Check your email for the beta link.",
      'gcta.spam_hint': "Don't see it? Check your spam folder.",
      ...
      'rcta.spam_hint': 'Check your spam folder for our confirmation email.',
    ...
    de: {
      ...
      'gcta.headline': 'Werde Beta-Tester',
      'gcta.subtitle': 'Wir starten bald in Z\u00fcrich. Hinterlasse deine E-Mail und sei unter den Ersten.',
      'gcta.email_ph': 'Deine E-Mail-Adresse',
      'gcta.btn': 'Beta-Tester werden',
      'gcta.success': 'Du bist auf der Liste! Pr\u00fcfe deine E-Mails f\u00fcr den Beta-Link.',
      'gcta.spam_hint': 'Nicht gefunden? Schau im Spam-Ordner nach.',
      ...
      'rcta.spam_hint': 'Pr\u00fcfe deinen Spam-Ordner f\u00fcr unsere Best\u00e4tigungsmail.',
